  ...
  $(function()
  {
    ...
    jQuery("#grid_hits").jqGrid({
        ...
        gridComplete: function()
        {
          ...
          {
            var id = ids[i];
            edit = "<button class='ui-state-default ui-corner-all' onclick=\"jQuery('#grid_hits').editGridRow('"+id+"', {width:300});\"><span class='ui-icon ui-icon-pencil'></span></button>"; 
            del = "<button class='ui-state-default ui-corner-all' onclick=\"jQuery('#grid_hits').delGridRow('"+id+"');\"><span class='ui-icon ui-icon-trash'></span></button>";
            save = "<button class='ui-state-default ui-corner-all' onclick=\"jQuery('#grid_hits').saveRow('"+id+"');\" ><span class='ui-icon ui-icon-check'></span></button>"; 
